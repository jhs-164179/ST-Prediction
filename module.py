...
# # Ref: https://github.com/ChristophReich1996/Involution/tree/master
# class Inv2d(nn.Module):
#     def __init__(
#             self,
#             in_channels:int, out_channels:int, sigma_mapping:Optional[nn.Module]=None,
#             kernel_size:Union[int, Tuple[int, int]]=(7, 7), stride:Union[int, tuple[int, int]]=(1, 1),
#             groups:int=1, reduce_ratio:int=1, dilation:Union[int, tuple[int, int]]=(1, 1),
#             padding:Union[int, tuple[int, int]]=(3, 3), bias:bool=False, force_shape_match:bool=False
#     ):
...
# # Ref: https://github.com/ChristophReich1996/Involution/tree/master
# class Inv3d(nn.Module):
#     def __init__(
#             self,
#             in_channels:int, out_channels:int, sigma_mapping:Optional[nn.Module]=None,
#             kernel_size:Union[int, Tuple[int, int, int]]=(7, 7, 7), stride:Union[int, tuple[int, int, int]]=(1, 1, 1),
#             groups:int=1, reduce_ratio:int=1, dilation:Union[int, tuple[int, int, int]]=(1, 1, 1),
#             padding:Union[int, tuple[int, int, int]]=(3, 3, 3), bias:bool=False, force_shape_match:bool=False
#     ):
#         super(Inv3d, self).__init__()
#         self.in_channels = in_channels
#         self.out_channels = out_channels
...
#         # self.pad = nn.ConstantPad3d(padding=(self.padding[2], self.padding[2],
#         #                                      self.padding[1], self.padding[1],
#         #                                      self.padding[0], self.padding[0]), value=0.)        
